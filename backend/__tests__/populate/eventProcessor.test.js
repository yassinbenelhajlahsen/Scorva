...
jest.unstable_mockModule(
  resolve(__dirname, "../../src/populate/src/upsertTeam.js"),
  () => ({ default: mockUpsertTeam })
);
jest.unstable_mockModule(
  resolve(__dirname, "../../src/populate/src/upsertPlayer.js"),
  () => ({ default: mockUpsertPlayer })
);
jest.unstable_mockModule(
  resolve(__dirname, "../../src/populate/src/upsertStat.js"),
  () => ({ default: mockUpsertStat })
);
jest.unstable_mockModule(
  resolve(__dirname, "../../src/populate/src/upsertGame.js"),
  () => ({ default: mockUpsertGame })
);
jest.unstable_mockModule(
  resolve(__dirname, "../../src/populate/src/mapStatsToSchema.js"),
